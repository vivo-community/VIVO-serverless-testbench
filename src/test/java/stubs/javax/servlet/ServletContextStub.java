...
public class ServletContextStub implements ServletContext {
	...
	public ServletContextStub() {
        String benchAbsPath = (new File("src/main/resources/webapp")).getAbsolutePath();
        ...
        mockResources.put("/WEB-INF/resources/build.properties", 
                benchAbsPath+"/WEB-INF/resources/build.properties");
        ...
        this.setAttribute("vclassId", "http://vivoweb.org/ontology/core#FacultyMember");
    }
    // ----------------------------------------------------------------------
	// Stub infrastructure
	// ----------------------------------------------------------------------
